...
CAMERA_PORTS_V2 = (
    # RTSP / RTSPS
    554, 555, 8554, 10554, 5544, 6554, 7447, 322,
    # HTTP camera web interfaces / WebRTC / WHEP
    80, 81, 85, 88, 99, 1984,
    8000, 8008, 8080, 8081, 8082, 8083, 8088, 8089, 8090, 8099,
    2020, 7001, 8888, 8889, 9000,
    # HTTPS
    443, 8443,
    ...
    49152, 49153, 49154,
    # Additional
    1026, 7070, 4747, 2600, 8001,
)

# Ports that indicate HTTP services
HTTP_PORTS = {80, 81, 85, 88, 99, 1984, 2020, 7001, 8000, 8008, 8080, 8081, 8082, 8083, 8088, 8089, 8090, 8099, 8888, 8889, 8899, 9000}
HTTPS_PORTS = {443, 8443}
RTSP_PORTS = {554, 555, 8554, 10554, 5544, 6554, 7447, 322}
RTMP_PORTS = {1935}
